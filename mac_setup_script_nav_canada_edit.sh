# This script shamelessly stolen from https://github.com/ryanmaclean/OSX-Post-Install-Script
# NOTE TO SELF: This is a non-exhaustive list of shit I want to have:
  # brew
  # brew cask
  # iterm2
  # tmux (and my conf file)
  # textmate
  # atom.io
  # chrome
  # postgres
...
## CODING TOOLS
brew cask install bee iterm2 
# brew cask install sourcetree github chefdk
...
# NOTE: Maybe use KeepingYouAwake (github newmarcel/KeepingYouAwake) instead of caffeine
